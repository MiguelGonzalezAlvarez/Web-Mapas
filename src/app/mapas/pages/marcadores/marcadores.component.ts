...
export class MarcadoresComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    // Forma de poner marcadores de forma fija
    // Descomentar en caso de no querer crear dinamicamente los marcadores
    // this.crearMarcadorFijo();

  }

  crearMarcadorFijo(): void {
    const markerHtml: HTMLElement = document.createElement('div');
    markerHtml.innerHTML = 'Hola Mundo';

    // Ponemos un marcador en el centro del mapa
    new mapboxgl.Marker()
  ...
  leerLocalStorage() {
    if (!localStorage.getItem('marcadores')) {
      // Si no se han guardado marcadores entonces no hacemos nada
      return;
    }
